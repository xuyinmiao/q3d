...
# ===================== 训练准备 =====================
model = CNN(latent_dim=8, n_classes=10)
...
console = Console()
console.rule("[bold cyan]🚀 Fully Classical CNN Training Started[/bold cyan]")
console.print(Panel.fit(
    "[bold bright_cyan]Model:[/bold bright_cyan] Fully Classical CNN\n"
