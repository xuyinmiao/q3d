...
# ===================== 设置迭代次数和固定扰动 =====================
iterations_range = np.arange(0, 11, 2)  # 0, 5, 10, 15, ..., 50
...
plt.title(f"Adversarial Robustness vs. Iterations (CIFAR-10, ε={fixed_epsilon})", fontsize=18, fontweight='bold', pad=20)
